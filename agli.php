        ...
        <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            ...
            <li><a href="podnaem.php">ПОД НАЕМ</a></li>
                ...
                <div class="col-md-12 agli">
                  <div class="h2"><h2><b>ЪГЛИ</b></h2></div>
                  <div class="main">
                    <img class="img" src="img/pvcagal.jpg">
                    <h4><b>Ъгъл с мрежа - PVC</b></h4><br><br><br>
                    <ul>
                      <li>Ъглов профил с мрежа за армиране на ъгли.</li>
                      <li>Размер на мрежата: 10 х 10 см.</li>
                      <li>Опаковка: 25 бр.</li>
                    </ul><br><br><br><br>
                  </div>
                  <div class="main">
                    <img class="img" src="img/agal.jpg">
                    <h4><b>Thrakon PVC ъглов профил с мрежа</b></h4><br><br><br>
                    <ul>
                      <li>Пластмасов ъгъл с алкалоустойчива мрежа за оформяне на ъгли от 90°. </li>
                      <li>Дължина - 2,5 м</li>
                      <li>Размер на мрежата - 10 х 15 см</li>
                      <li>Разход кг/м2: 1 m / m' </li>
                    </ul><br><br>
                  </div>
                  <div class="main">
                    <img class="img" src="img/aluminiev.jpg">
                    <h4><b>Алуминиев ъгъл двустранно перфориран 135о 2.50м </b></h4><br><br><br>
                    <ul>
                      <li>Дължина - 2,5 м</li>
                    </ul><br><br>
                  </div>
                  <div class="main">
                    <img class="img" src="img/ednoramo.jpg">
                    <h4><b>Алуминиев ъгъл с едно рамо(едностранно перфориран)</b></h4><br><br><br>
                    <ul>
                      <li>Дължина - 2,5 м</li>
                      <li>Алуминиев ъглов профил, предназначен за оформяне на ъгли под 90° при всякакви строителни работи.</li>
                    </ul><br><br>
                  </div>
                  <div class="main">
                    <img class="img" src="img/arka.bmp">
                    <h4><b>Ъгъл PVC за огъване - 2.50м</b></h4><br><br><br>
                    <ul>
                      <li>Пластмасов ъгъл за огъване</li>
                      <li>Дължина - 2,5 м</li>
                    </ul><br><br>
                  </div>
                  <div class="main">
                    <img class="img" src="img/skrit.jpg">
                    <h4><b>Водооткапващ профил за скрит монтаж</b></h4><br><br><br>
                    <ul>
                      <li>VC ъглов профил с интегрирана алкалоустойчива стъклотекстилна мрежа</li>
                      <li>скрита водооткапваща част</li>
                    </ul><br><br>
                  </div>
                  <div class="main">
                    <img class="img" src="img/vodootkapvasht.jpg">
                    <h4><b>Профил ъглов водооткапващ ПВЦ с мрежа, без видим ръб</b></h4><br><br>
                    <h4><b>ОПИСАНИЕ</b></h4><br><br>
                        <p>Пластмасов ъглов профил с мрежа, предназначен за отвеждане на стичащата се по фасадата вода надолу без подлизване. Предназначение открит монтаж. </p><br><br>
                  </div>
                  <div class="main">
                    <img class="img" src="img/pocinkovan.jpg">
                    <h4><b>Ъгъл поцинкован за мазилка 2.6м  </b></h4><br><br><br>
                    <ul>
                      <li>VC ъглов профил с интегрирана алкалоустойчива стъклотекстилна мрежа</li>
                      <li>скрита водооткапваща част</li>
                    </ul><br><br>
                  ...
                  <div class="main">
                    <img class="img" src="img/okantvasht.bmp">
                    <h4><b>Ъгъл PVC окантващ за ГКП 12.5мм - 3.00м</b></h4><br><br><br><br><br>
                  </div>
