...
<head>
  ...
  <style type="text/css">
    ...
    .dvoinaprujina, .ankerBarz, .ankerVinkel, .telSUho, .udaljitel, .staklofazerna, .samozalepvashta {
      width: 10%;
    }
    @media screen and (max-width: 500px) {
    ...
    <div class="col-md-12 col-centered">
      ...
      <div class="col-md-12 aksesoari">
        ...
        <div class="direktenOkachvach">
          ...
          <div class="direktenOkachvach">
          <img class="okachvach staklofazerna" src="img/staklofazerna.jpg"><br>
          <h3><b>ЛЕНТА СТЪКЛОФАЗЕРНА 25м</b></h3><br>
          <ul>
            <li>дължина мм.   25 000</li>
            <li>ширина мм.  50</li>
          </ul>
          <h4><b>ОПИСАНИЕ</b></h4><br>
          <p><b>Стъклофазерна фугопокривна лента с ширина 50 мм и дължина 25м.<br>
           Препоръчва се за покриване на фуги при гипскартонени/гипсфазерни огнезащитни системи за сухо строителство.<br></b></p><br><br>
          </div>
          <div class="direktenOkachvach">
          <img class="okachvach samozalepvashta" src="img/samozalepvashta.jpg"><br>
          <h3><b>МРЕЖА САМОЗАЛЕПВАЩА ЗА ФУГИ 90м-45м-20м</b></h3><br>
          <ul>
            <li>дължина мм.   90 000 / 45 000 / 20 000</li>
            <li>ширина мм.  50</li>
          </ul>
          <h4><b>ОПИСАНИЕ</b></h4><br>
          <p><b>Самозалепваща фугопокривна лента тип мрежа с ширина 50 мм и дължина 20м/45м/90м<br>
           Самозалепваща стъклофазерна мрежа за покриване на фуги при различни системи за сухо строителство.<br></b></p><br><br>
          </div>
