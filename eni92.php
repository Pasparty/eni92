	...
	<div class="container">
      ...
      <a href="https://www.facebook.com/eni92.eood/?fref=ts"><img class="facebook" src="img/facebook.ico"></a>
		...
		<div class="col-md-12">
			...
			<a href="eni92.php"><img class="logo" src="img/eni92.jpg"></a>
		</div>
		<div class="col-md-12 col-centered">
			...
			<ul class="img-list">
				<li>
					<a href="kominnitela.php">
						<img src="img/kominnotqlo.png" />
						<span class="text-content"><span>КОМИННИ ТЕЛА</span></span>
					</a>
				</li>
				<li>
					<a href="shturcove.php">
						<img src="img/shturc.jpg" />
						<span class="text-content"><span>ЩУРЦОВЕ</span></span>
					</a>
				</li>
				<li>
					<a href="tuhli.php">
				...
				<li>
					<a href="ploskosti.php">
						<img src="img/ploskosti.jpg" />
						<span class="text-content"><span>ПЛОСКОСТИ</span></span>
					</a>
				</li>
				<li>
					<a href="agli.php">
						<img src="img/agli.jpg" />
						<span class="text-content"><span>ЪГЛИ</span></span>
					</a>
				</li>
			</ul>
			<div class="push"></div>
