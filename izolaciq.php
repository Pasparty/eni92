			...
			<div class="col-md-12 izolacii">
				...
				<div class="EPS">
					...
					<div class="EPS">
						...
						<img class="tiktak" src="img/gipsofazer.jpg">
						<div class="tictac">
							<h4><b>Гипсофазер </b></h4><br><br>
							<p><b>Гипсофазер размери:</b></p>
							<ul>
								<li>1000х1500х10 мм</li>
								<li>1200х2000х10 мм</li>
								<li>1200х2500х10 мм</li><br>
								<li><b>Приложение:</b></li>
								<li>за фасада</li>
								<li>за кухни</li>
								<li>за бани</li>
								<li>за други мокри помещения</li><br>
								<li><b>Свойства на гипсофазер</b></li>
								<li>устойчив на влага</li>
								<li>издържа на атмосферните влияния - дъжд, сняг, високи и ниски температури</li>
								<li>високоинпрегнирана плоскост</li>
								<li>отличен избор за фасадна топлоизолация или </li>
							</ul><br><br>
