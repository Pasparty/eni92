...
<html>
  <head>
    <title>Ени-92 КОМИННИ ТЕЛА</title>
        ...
        <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            ...
            <li><a href="podnaem.php">ПОД НАЕМ</a></li>
                ...
                <div class="col-md-12 kominniTela">
                  <div class="h2"><h2><b>КОМИННИ ТЕЛА</b></h2></div>
                  <div class="main">
                    <img class="img" src="img/kominnotqlo.png">
                    <h4><b>Коминни тела</b></h4><br><br><br>
                    <ul>
                      <li>Размер: 250 x 250 x 330, ф 180 mm</li>
                      <li>Размер: 320 x 320 x 330, ф 250 mm</li>
                    </ul><br><br><br>
                  </div>
