        ...
        <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            ...
            <li><a href="podnaem.php">ПОД НАЕМ</a></li>
                ...
                <div class="col-md-12 ploskosti">
                  <div class="h2"><h2><b>ПЛОСКОСТИ</b></h2></div>
                  <div class="main">
                    <img class="img" src="img/osb.jpg">
                    <h4><b>ОСБ 2 9мм 2440х1220</b></h4><br>
                    <ul>
                      <li>дължина мм.   2440</li>
                      <li>ширина мм.  1220</li>
                      <li>дебелина мм.  9</li>
                    </ul>
                    <h4><b>ОПИСАНИЕ</b></h4><br>
                    <p>Плочите от ориентирани частици OSB 2 - обикновено, с основно приложение в строителната индустрия. Плочите от ориентирани частици се произвеждат от 100 % иглолистна дървесина. Дългите и тънки частици са разположени в три напречно ориентирани слоя. Тази технология, позната от производството на шперплат, и наслагването на фурнирни частици (95 мм / 0.65 мм) гарантират стабилността на размерите и много висока механична устойчивост.</p><br><br>
                  </div>
                  <div class="main">
                    <img class="img" src="img/osb.jpg">
                    <h4><b>ОСБ 2 11мм 2440х1220</b></h4><br>
                    <ul>
                      <li>дължина мм.   2440</li>
                      <li>ширина мм.  1220</li>
                      <li>дебелина мм.  11</li>
                    </ul>
                    <h4><b>ОПИСАНИЕ</b></h4><br>
                    <p>Плочите от ориентирани частици OSB 2 - обикновено, с основно приложение в строителната индустрия. Плочите от ориентирани частици се произвеждат от 100 % иглолистна дървесина. Дългите и тънки частици са разположени в три напречно ориентирани слоя. Тази технология, позната от производството на шперплат, и наслагването на фурнирни частици (95 мм / 0.65 мм) гарантират стабилността на размерите и много висока механична устойчивост.</p><br><br>
                  </div>
                  <div class="main">
                    <img class="img" src="img/vodoustoichiv.jpg">
                    <h4><b>Шперплат - Влагоустойчив Шперплат</b></h4><br>
                    <ul>
                      <li>дължина мм.   2440</li>
                      <li>ширина мм.  1220</li>
                      <li>дебелина мм.  11</li>
                    ...
                    <h4><b>ОПИСАНИЕ</b></h4><br>
                    <p><b>Водоустойчивият /Хидрофобният/</b> шперплат е съставен от кръстосани редуващи се пластове /13-слоя/ тополов фурнир, което придава здравина на материала /шперплата/. Всички листове на водоустойчивият /хидрофобен/ шперплат поотделно са с дебелина под 2 мм, подредени така, че посоката на дървесните нишки на всеки от листовете е под прав ъгъл спрямо посоката на нишките на следващия слой, слепени с лепило и пресовани.<br><br>Водоустойчивият /Хидрофобен/ шперплат има широка употреба предимно в строителството. Използва се за хоризонтален, вертикален кофраж.</p><br><br>
                  </div>
