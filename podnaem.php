        ...
        <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            ...
            <li><a href="podnaem.php">ПОД НАЕМ</a></li>
                ...
                <div class="col-md-12 podNaem">
                  <div class="h2"><h2><b>ПОД НАЕМ</b></h2></div>
                  <div class="main">
                    <img class="img" src="img/kofrajniplatna.jpg">
                    <h4><b>Плaтна</b></h4><br><br><br>
                  ...
                  <div class="main">
                    <img class="img" src="img/shperplat.jpg">
                    <h4><b>Шперплат</b></h4><br><br><br>
                    <h4><b>ОПИСАНИЕ</b></h4><br>
                    <ul>
                      <li><b>Размери:</b></li>
                      <li>200/50/0,21</li>
                  ...
                  <div class="main">
                    <img class="img" src="img/podpori.jpg">
                    <h4><b>Телескопични подпори</b></h4><br><br><br>
                    <h4><b>ОПИСАНИЕ</b></h4><br>
                    <ul>
                      <li><b>Размери:</b></li>
                      <li>Н – 2.00 до 3.60 метра</li>
                    </ul><br><br>
                  </div>
                  <div class="main">
                    <img class="img" src="img/skele.jpg">
                    <h4><b>Скеле</b></h4><br><br><br>
                    <h4><b>ОПИСАНИЕ</b></h4><br>
                    <ul>
                      <li><b>Италианско и Българско</b></li>
                      <li>700 кв. м.</li>
                    </ul><br><br>
                  </div>
