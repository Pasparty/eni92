        ...
        <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            ...
            <li><a href="podnaem.php">ПОД НАЕМ</a></li>
                ...
                <div class="col-md-12 shturcove">
                  <div class="h2"><h2><b>КОМИННИ ТЕЛА</b></h2></div>
                  <div class="main">
                    <img class="img" src="img/shturc.jpg">
                    <h4><b>Щурц керамичен</b></h4><br><br><br>
                    <h4><b>ОПИСАНИЕ</b></h4><br>
                    <p><b>Състоят се от керамична обвивка, предварително напрегната армировка и специален бетонов пълнеж. Използват се за премостване на светли отвори като врати и прозорци. Предлагат се на дължини от 1 до 3 m, през 25 cm.</p><br><br>
                  </div>
