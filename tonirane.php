        ...
        <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            ...
            <li><a href="podnaem.php">ПОД НАЕМ</a></li>
                ...
                <div class="col-md-12 tonirane">
                  <div class="h2"><h2><b>ТОНИРАНЕ</b></h2></div>
                  <div class="main">
                    <img class="img" src="img/x-smart.png">
                    <p><b>FAST&FLUID</b> E компютърна технология за тониране на бои и мазилки, с помощта на база данни от над 3 милиона рецепти за оцветяване.<br><br>С използване на компютърните нюансирани системи и мощен софтуер, всяко желание за сянка или друг отенък се вписва и се съхранява в компютъра, така че  цвета може да бъде възпроизведен отново. <br><br>Софтуерните програми, използвани от машините,  дават възможност за тониране на цветове за бои за интериора, екстериора, мазилки, алкидни и акрилни. <b>FAST&FLUID</b> впечатлява с най-новите технологии и с гъвкава система за компютъризирано тониране. </p>
                  </div>
