...
<html>
<head>
  <title>Ени-92 ТРАНСПОРТ И ДОСТАВКА</title>
  ...
  <div class="container">
    ...
    <div class="col-md-12 col-centered">
      ...
      <div class="col-md-12 transport">
        ...
        За да осигурим удобство, бърза и коректна доставка на всички клиенти на магазина, предлагаме избор на няколко начина на доставка на вашата поръчка.<br><br>
        <h1>Начини на доставка</h1>
        
        <b>1. С куриерска фирма</b><br>
        Една част от поръчките направени от магазина се изпълняват използвайки услугите на куриерска фирма за транспорт и доставка.<br>
        
        Показаната цена за доставка е на база теглото на поръчаните продукти. При обемни продукти, като стиропор, фибран и вата, доставката се смята на база обемно тегло и подлежи на корекция.<br><br>
        <b>2. Транспорт на ЕНИ-92 ЕООД.</b><br><br>
        <h1>Срок на доставка</h1>
        
        Стандартния срок на доставка е 1 Работен ден. Поради спецификата и разнообразието на предлагания от ЕНИ-92 ЕООД асортимент, сроковете за доставка на всяка поръчка се уточняват по телефона преди нейното изпълнение.<br>
